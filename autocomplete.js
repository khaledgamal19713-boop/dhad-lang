const BUILTIN_NAMES = ["اطبع", "طول", "أضف", "نص", "عدد", "احفظ_ملف", "جذر", "قوة", "مطلق", "الأكبر", "الأصغر", "عشوائي", "اقتطع", "استبدل", "يحوي", "افصل", "اربط", "قصّ", "رتب", "اعكس", "عنصر_جديد", "أضف_ابن", "عيّن_نص", "عيّن_نمط", "عند_نقر", "اقرأ_قيمة", "عيّن_قيمة", "الجذر", "نفّذ"];
